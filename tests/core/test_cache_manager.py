...
class TestRomCacheManager:
    ...
    def test_compute_rom_hash_small_file(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            cache = RomCacheManager(tmp, cache_partitions=True)
