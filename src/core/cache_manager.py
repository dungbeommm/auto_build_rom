"""
ROM Cache Manager - Hierarchical caching for ROM porting

This module provides a hierarchical caching system for ROM processing,
...
Usage:
    ...
    cache = RomCacheManager(".cache/roms")

    # Enable partition caching for multi-device reuse
    cache = RomCacheManager(".cache/roms", cache_partitions=True)
...
class RomCacheManager:
    ...
    Manages partition and APK modification caches for ROM processing.
...
def get_cache_manager(cache_root: Union[str, Path] = DEFAULT_CACHE_ROOT) -> RomCacheManager:
    """Get cache manager instance."""
    return RomCacheManager(cache_root)
