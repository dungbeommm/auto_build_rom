...
class RomPackage:
    ...
    def __init__(
        ...
        label: str = "Rom",
        cache_manager: Optional["RomCacheManager"] = None,
    ):
        ...
        Args:
            ...
            cache_manager: Optional cache manager for ROM extraction caching.
        """
        ...
        self.cache_manager: Optional["RomCacheManager"] = cache_manager
    ...
    def extract_images(self, partitions: Optional[List[str]] = None) -> None:
        ...
        Args:
            partitions:
                ...
                - If list specified (ROM): Extract only specific imgs, and extract them.
        """
        ...
        try:
            if self.rom_type == RomType.PAYLOAD:
                # Extract with metadata for ROM to enable auto-configuration
    ...
    def export_props(self, output_path: Union[str, Path]) -> None:
        ...
        content = [
            ...
            "# Generated by HyperOS ROM Modifier",
            "# ==========================================\n",
        ]
