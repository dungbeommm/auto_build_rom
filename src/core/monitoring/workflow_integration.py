...
class MonitoredPortingWorkflow:
    ...
    def __init__(self, context: RomContext, report_path: Optional[Path] = None):
        self.ctx = context
...
def run_monitored_porting(context: RomContext, report_path: Optional[Path] = None) -> bool:
    ...
    Example:
        ctx = RomContext(stock_rom, port_rom, target_dir)
