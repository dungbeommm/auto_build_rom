#!/usr/bin/env python3
"""
Cache Management Tool for HyperOS ROM Modifier

This tool provides a CLI for managing ROM caches, allowing users to:
- List cached ROMs
...
def main():
    parser = argparse.ArgumentParser(
        description="Cache Manager for ROMs",
...
Examples:
  ...
  python tools/cache_manager.py verify
    ...
    parser.add_argument(
        "--cache-dir", default=".cache/roms", help="Cache directory (default: .cache/roms)"
    )
    ...
    list_parser = subparsers.add_parser(
        ...
        description="List all cached ROMs with their partitions",
    )
    ...
    cache = RomCacheManager(args.cache_dir)
